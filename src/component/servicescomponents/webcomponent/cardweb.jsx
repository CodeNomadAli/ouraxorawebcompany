...
const Cardweb = () => {
  return (
    <section className="w-full py-20 bg-gray-50 overflow-hidden">
      {/* Main Container - Exact same alignment as Clientsay */}
      <div className="max-w-7xl 2xl:max-w-[1450px] min-[1700px]:max-w-[1550px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Packages Grid - Fixed width for 768px (md) to match Navbar/Clientsay */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 py-10">
          
          {/* Card 1 */}
          <div className="w-full min-h-[480px] p-8 border border-gray-200 bg-white rounded-[2rem] shadow-sm hover:shadow-xl hover:border-blue-600 transition-all duration-300 flex flex-col justify-between group">
            <div>
            ...
            <button className="w-full bg-blue-50 group-hover:bg-blue-600 group-hover:text-white text-blue-700 font-bold rounded-2xl py-4 mt-8 transition-all">
              View Pricing
            </button>
          </div>

          {/* Card 2 - Featured */}
          <div className="w-full min-h-[500px] p-8 border-2 rounded-[2rem] border-blue-500 bg-white shadow-2xl relative flex flex-col justify-between lg:scale-105 z-10">
            ...
            <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl py-4 mt-8 transition-all shadow-xl shadow-blue-200">
              Select Package
            </button>
          </div>
          ...
          <div className="w-full min-h-[480px] p-8 border border-gray-200 bg-white rounded-[2rem] shadow-sm hover:shadow-xl hover:border-blue-600 transition-all duration-300 flex flex-col justify-between group">
            ...
            <button className="w-full bg-gray-900 hover:bg-black text-white font-bold rounded-2xl py-4 mt-8 transition-all">
              Contact Sales
            </button>
          </div>
