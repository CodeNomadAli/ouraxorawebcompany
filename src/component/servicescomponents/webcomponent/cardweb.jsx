...
const Cardweb = () => {
  return (
    <section className="w-full px[100px] py-20 bg-gray-50">
       <div className="text-center">
        <p className="text-3xl font-bold">Transparent Development Packages</p>
        <p className="text-gray-500 py-4">One-time fees. You own the code. No monthly builders fees.</p>
       </div>

       <div className="grid md:grid-cols-3 grid-flex px-[100px] py-16">
        {/*car 1 */}
         <div className="w-[370px] h-[450px] p-8 border-[1px] mt-3 rounded-2xl border-gray-100 bg-white shadow-lg hover:border-blue-600">
             ...
             <div className="flex  ">
                ...
                <p className="text-sm text-gray-400 px-5 mt-1 ">1 Week Turnaround</p>
                 ...
                 <div className="text-center">
                   <button className="w-full bg-blue-100 hover:bg-blue-200 text-blue-900 font-bold rounded-xl text-xl py-2 mt-7 flex items-center justify-center "> View Pricing</button>
                </div>

         </div>

            {/*car 2 */}
          <div className="w-[370px] h-[450px] p-8 border-2 rounded-2xl border-blue-500 bg-white shadow-lg">
             ...
             <div className="flex  ">
                ...
                <p className="text-sm text-gray-400 px-5 mt-1 ">Google Analytics Setup</p>
                 ...
                 <div className="text-center">
                   <button className="w-full bg-blue-700 hover:bg-blue-600 text-white font-bold rounded-xl text-xl py-3 mt-7 flex items-center justify-center "> Select Package</button>
                </div>
           ...
           <div className="w-[370px] h-[450px] p-8 border-[1px] mt-3 rounded-2xl border-gray-100 bg-white shadow-lg hover:border-blue-600">
             ...
             <div className="flex  ">
                ...
                <p className="text-sm text-gray-400 px-5 mt-1 ">Advanced Search & Filtering</p>
                 ...
                 <div className="text-center">
                   <button className="w-full bg-gray-50 hover:bg-gray-100 text-black border-[1px] border-gray-200 font-bold rounded-xl text-xl py-2 mt-7 flex items-center justify-center "> Contact Sales</button>
                </div>
