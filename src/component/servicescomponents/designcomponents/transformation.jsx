...
const Transformation = () => {
  // --- Animation Variants (Consistent Speed) ---
    ...
    <section className="w-full overflow-hidden">
      ...
      <div className="w-full bg-gray-50 py-16 md:py-24">
        <div className="max-w-7xl 2xl:max-w-[1450px] min-[1700px]:max-w-[1550px] mx-auto px-4 sm:px-10 lg:px-8">
          ...
          >
            {/* Card 1 */}
            <motion.div variants={itemVariants} className="w-full group cursor-pointer max-w-3xl mx-auto">
      ...
      <div className="w-full py-20 bg-white overflow-hidden">
        <div className="max-w-7xl 2xl:max-w-[1450px] min-[1700px]:max-w-[1550px] mx-auto px-4 sm:px-10 lg:px-8">
          ...
          >
            {/* Card 1 */}
            <motion.div variants={itemVariants} className="w-full flex flex-col p-8 border border-gray-100 rounded-[2rem] bg-white shadow-lg hover:border-blue-500 transition-all group">
              <div className="flex-grow">
                ...
                <div className="space-y-4 mt-4">
                  {["Expert Heuristic Analysis", "Accessibility Check", "PDF Report", "1 Hour Consultation"].map((text, i) => (
              ...
              <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="w-full mt-10 py-4 border border-gray-200 rounded-2xl font-bold hover:bg-gray-50 transition-all">View Pricing</motion.button>
            </motion.div>
            ...
            {/* Card 3 */}
            <motion.div variants={itemVariants} className="w-full md:col-span-2 lg:col-span-1 flex flex-col p-8 border border-gray-100 rounded-[2rem] bg-white shadow-lg hover:border-blue-500 transition-all max-w-md md:mx-auto lg:max-w-full">
              <div className="flex-grow">
