...
import {  FaSearch,FaBars, FaBullhorn, FaBuilding } from "react-icons/fa";

const Diamondsec = () => {
  return (
    <section className="w-full ">
      <div className="px-[100px] w-full bg-gray-900 py-12">
        <div>
         <h1 className="text-blue-600 font-bold text-2sm">How We Design</h1>
         <h2 className="text-3xl text-white font-bold py-2">The "Double Diamond" Process</h2>
         <p className="tex-2sm text-gray-200">We don't guess. We follow a proven framework to discover the problem and <br /> deliver the solution.</p>
        </div>
     ...
     <div className="md:text-right md:pr-16">
       ...
       <p className="text-gray-500">We start by understanding the "Who" and the "Why". We conduct stakeholder interviews and user surveys.</p>
   ...
   <div>
      <div className="w-16 h-16 bg-gray-600 mt-7 ml-16 rounded-xl flex items-center justify-center">
        <FaSearch className="text-blue-500 w-6 h-6" />
      </div>
   </div>

    <div className="absolute left-4 md:left-1/2 top-0 -translate-x-1/2">
      <div className="w-4 h-4 rounded-full bg-blue-500 text-white flex mt-12  items-center justify-center font-bold shadow-lg"></div>
    </div>
  ...
  <div className="w-16 h-16 bg-gray-600 mt-7 rounded-xl mr-16 flex items-center justify-center">
    ...
    <div className="md:text-left ml-12 md:pr-16">
       ...
       <p className="text-gray-500">We organize the chaos. We define the user flow (Information Architecture) and sketch low-fidelity layouts.</p>
    ...
    <div className="absolute left-4 md:left-1/2 top-0 -translate-x-1/2">
      <div className="w-4 h-4 rounded-full bg-gray-500 text-white flex mt-12  items-center justify-center font-bold shadow-lg"></div>
    </div>
  </div>
     ...
     <div className="md:text-right md:pr-16">
       ...
       <p className="text-gray-500">This is where it gets beautiful. We apply your branding, colors, and typography to create high-fidelity screens.</p>
   ...
   <div>
    ...
    <div className="absolute left-4 md:left-1/2 top-0 -translate-x-1/2">
      <div className="w-4 h-4 rounded-full bg-purple-500 text-white flex mt-12  items-center justify-center font-bold shadow-lg"></div>
    </div>
  ...
  <div className="w-16 h-16 bg-gray-600 mt-7 rounded-xl mr-16 flex items-center justify-center">
    ...
    <div className="md:text-left ml-12 md:pr-16">
       ...
       <p className="text-gray-500">We link the screens to create a clickable prototype. Once approved, we prep files for developers.</p>
    ...
    <div className="absolute left-4 md:left-1/2 top-0 -translate-x-1/2">
      <div className="w-4 h-4 rounded-full bg-gray-500 text-white flex mt-12  items-center justify-center font-bold shadow-lg"></div>
        ...
        <div className="w-full px-[100px]">
          <div className="bg-white text-center py-8 px[100px] group">
