...
const FAQ = () => {
  return (
    <section className="bg-gray-50 w-full py-20 px-4 sm:px-6 md:px-12 lg:px-24 flex flex-col items-center text-center">
      ...
      <p className="text-base sm:text-lg md:text-xl max-w-3xl mb-10">
      ...
      {/* Call to Action */}
      <div className="w-full max-w-3xl bg-gray-900 rounded-xl p-6 md:p-8 flex flex-col md:flex-row items-center md:justify-between gap-6 md:gap-12 mx-auto h-auto">
        ...
        <div className="flex justify-center md:justify-end w-full md:w-auto">
          <a target="_blank" rel="noreferrer" href="https://calendly.com/axoraweb/30min">
            <button className="bg-white text-black px-4 md:px-6 py-2 rounded-lg text-base md:text-xl hover:bg-gray-200">
              Chat with an Expert
            </button>
          </a>
        </div>
